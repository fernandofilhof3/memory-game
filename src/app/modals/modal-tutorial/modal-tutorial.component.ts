...
export class ModalTutorialComponent implements OnInit {
  ...
  public nextStep() {
    ...
    if (this.currentStep === 2) {
      ...
      como dano, o ataque do pokemon da primeira carta <br/> Ex: Você virou um <strong>meowth</strong> e um <strong>eevee</strong>,
       você irá receber 2 danos do <strong>meowth</strong>. Caso forme um par você não receberá dano.`;
    }
